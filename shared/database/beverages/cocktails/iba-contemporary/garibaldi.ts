...
export const garibaldi: Cocktail = {
  ...
  ingredients: [
    ...
    },
    {
      ...
      note: { en: 'freshly squeezed', it: 'appena spremuto', vi: 'vắt tươi' },
    },
  ],
  ...
  notes_for_staff: 'CRITICAL: Must use freshly squeezed orange juice - never carton juice. The fluffy, pulpy texture is what makes this drink special. Some bartenders use a hand juicer for extra fluffy texture. Build in glass, don\'t shake.',
