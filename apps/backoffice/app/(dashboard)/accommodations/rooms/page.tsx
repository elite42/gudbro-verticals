...
import { RoomManager } from '@/components/accommodations/RoomManager';
...
export default function RoomsPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl p-6">
      <h1 className="mb-6 text-2xl font-bold text-gray-900">Room Management</h1>
      <RoomManager propertyId={PROPERTY_ID} />
    </div>
  );
}
