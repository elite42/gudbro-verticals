...
const BUSINESS_DATA = {
  ...
  description:
    'Professional motorbike and scooter rentals in Da Nang, Vietnam. Honda Wave, Yamaha Exciter, VinFast electric scooters, and bicycles available. Book online with instant confirmation.',
  type: 'Bike Rental',
  city: 'Da Nang',
  country: 'Vietnam',
