...
export interface MultiLangText {
  en: string;
  it?: string; // Made optional - translations in progress
  vi?: string; // Made optional - translations in progress
  ko?: string;
  ja?: string;
  zh?: string;
  th?: string;
...
// ============================================================================
// ALLERGENS - 30 Total (Sistema 5 Dimensioni v3.0 - Dimensione 1)
// ============================================================================
...
export interface IngredientMaster {
  ...
  // Sistema 5 Dimensioni - AUTO-ASSIGNED
...
export interface Product {
  ...
  preparation?: {
    ...
    temperature?: 'hot' | 'cold' | 'room' | 'mixed';
  };
