...
export default function PropertyPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] pb-24">
      ...
      {/* Bottom Navigation */}
      <nav className="pb-safe-bottom fixed bottom-0 left-0 right-0 z-50 border-t border-[#E8E4DF] bg-white px-6 pt-2">
        <div className="mx-auto flex max-w-lg items-center justify-between">
          {/* Home */}
          <button
            onClick={() => setActiveTab('home')}
            className={`flex flex-col items-center py-2 transition-all ${
              activeTab === 'home' ? 'scale-110 text-[#E07A5F]' : 'text-[#6B6560]'
            }`}
          >
            <svg
              className="h-6 w-6"
          ...
          <button
            ...
            className={`flex flex-col items-center py-2 transition-all ${
              activeTab === 'map' ? 'scale-110 text-[#E07A5F]' : 'text-[#6B6560]'
            }`}
          >
            <svg
              className="h-6 w-6"
          ...
          <button
            ...
            className="flex flex-col items-center py-2 text-[#6B6560] transition-all hover:text-[#E07A5F]"
          >
            <svg
              className="h-6 w-6"
              fill="none"
          ...
          <button
            ...
            className={`flex flex-col items-center py-2 transition-all ${
              activeTab === 'services' ? 'scale-110 text-[#E07A5F]' : 'text-[#6B6560]'
            }`}
          >
            <svg
              className="h-6 w-6"
          ...
          <button
            ...
            className={`flex flex-col items-center py-2 transition-all ${
              activeTab === 'profile' ? 'scale-110 text-[#E07A5F]' : 'text-[#6B6560]'
            }`}
          >
            <svg
              className="h-6 w-6"
