              ...
              {file && step === 'upload' && (
                <div className="mt-4">
                  <Button onClick={handleUpload} className="w-full">
                    <UploadSimple className="mr-2 h-4 w-4" /> Start AI Extraction
                  </Button>
                </div>
              )}
              ...
              {step === 'review' && (
                <div className="mt-4 rounded-md bg-green-50 p-4 text-green-700 dark:bg-green-900/20 dark:text-green-400">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="mt-3 w-full border-green-200 hover:bg-green-100 dark:border-green-800 dark:hover:bg-green-900/50"
                    onClick={() => {
                      setStep('upload');
                      setFile(null);
