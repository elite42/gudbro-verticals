...
export const elPresidente: Cocktail = {
  ...
  notes_for_staff: 'Use quality aged Cuban-style rum (Havana Club 7 or similar). Real grenadine (pomegranate) is essential - not red syrup. The drink should be coral-colored, not red. Stir gently to maintain clarity.',
  ...
  source: {
    ...
    note: 'Created at Havana\'s Jockey Club, 1920s. Classic Cuban cocktail from the golden age of Havana.',
  },
