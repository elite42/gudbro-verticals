...
export const fuzzyNavel: Cocktail = {
  ...
  notes_for_staff: 'Add vodka to make it a "Hairy Navel". Use fresh orange juice for best flavor. Very popular with college-age crowds. Quality peach schnapps recommended - avoid artificial flavors.',
  ...
  source: {
    ...
    note: 'Created in 1984 by National Distillers for DeKuyper Peachtree Schnapps marketing.',
  },
