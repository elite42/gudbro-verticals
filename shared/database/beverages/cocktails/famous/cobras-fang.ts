...
export const cobrasFang: Cocktail = {
  ...
  notes_for_staff:
    'Created by Don the Beachcomber in 1930s, decoded by Jeff Berry. Very potent - warn guests about delayed alcoholic kick. Can substitute passion fruit purée for syrup. The "cobra bite" comes from high-proof Demerara rum. Serve with caution.',
  ...
  source: {
    ...
    notes:
      'Original Don the Beachcomber recipe from 1930s, decoded by Jeff "Beachbum" Berry in Sippin\' Safari.',
  },
