          ...
          <div className="flex">
            {[1, 2, 3, 4, 5].map((step) => (
              <div key={step} className="flex-1 py-3">
                <div className={`h-1 rounded-full mx-1 transition-colors ${
      ...
      <main className="max-w-2xl mx-auto px-4 py-12">
        ...
        {currentStep === 1 && (
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <p className="text-gray-600 mb-8">Create your GUDBRO account in minutes</p>
        ...
        {currentStep === 2 && (
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <p className="text-gray-600 mb-8">We'll customize your experience</p>
        ...
        {currentStep === 3 && (
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <p className="text-gray-600 mb-8">All plans include a 14-day free trial</p>
        ...
        {currentStep === 4 && (
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <p className="text-gray-600 mb-8">Make it yours</p>
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
                <p className="text-sm text-gray-500 mt-1">Leave empty to use your business name</p>
              </div>
              ...
              <div className="mt-8 p-6 rounded-xl border border-gray-200">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-bold text-gray-900">{brandName || businessName || 'Your Brand'}</p>
        ...
        {currentStep === 5 && (
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Add your first location</h1>
            <p className="text-gray-600 mb-8">You can add more locations later</p>
            ...
            <div className="space-y-6">
              ...
              <div className="mt-8 p-6 rounded-xl bg-gray-50">
                <p className="text-sm font-medium text-gray-700 mb-4">Summary</p>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-gray-600">Plan</span>
                    <span className="font-medium text-gray-900">{SUBSCRIPTION_PLANS.find(p => p.id === selectedPlan)?.name}</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-gray-900">{city}, {COUNTRIES.find(c => c.code === countryCode)?.name}</span>
                  </div>
              ...
              <div className="flex gap-4">
                ...
                <button
                  ...
                  disabled={isSubmitting}
                  className="flex-1 bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 rounded-xl font-semibold hover:from-blue-700 hover:to-purple-700 transition-all disabled:opacity-50"
                >
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-gray-500 mb-4">Trusted by 1,000+ restaurants worldwide</p>
