...
export const ginAndTonic: Cocktail = {
  ...
  notes_for_staff:
    "Quality matters - use premium gin and tonic. The ratio can vary from 1:1 to 1:3 depending on preference. Always use fresh ice and cold tonic. In Spain, serve in balloon glass with elaborate garnishes (rosemary, juniper berries, citrus). Don't over-stir - preserve the bubbles.",
  ...
  source: {
    ...
    notes:
      'Traditional recipe with modern craft variations. Historical information from various cocktail history sources.',
  },
