...
| -------------------- | ------------------------- | -------------------------------------- | -------------- | ---------- | ------------------------------------------------------------------------- |
| AI-FIRST-REDESIGN    | Backoffice AI-First       | Redesign UX da gestionale a Co-Manager | Backoffice/UX  | High       | **NEW** - Audit Atlas 2026-01-13 → vedi `docs/specs/AI-FIRST-REDESIGN.md` |
...
| WEATHER-INTEL        | Weather Intelligence      | Meteo in backoffice + AI               | AI/Analytics   | Medium     | **COMPLETATO** 2026-01-13 - WeatherWidget in header                       |
...
**Vision:** Trasformare il backoffice da "gestionale con AI" a "AI Co-Manager con strumenti gestionali".

**Audit:** ChatGPT Atlas (2026-01-13) - Documento completo in `docs/specs/AI-FIRST-REDESIGN.md`

**Problema principale:** Dashboard informativa, non operativa. L'AI aspetta invece di guidare.

**Sprint Plan:**

| Sprint | Focus                                | Effort     | Status |
| ------ | ------------------------------------ | ---------- | ------ |
| 1      | Dashboard Hero (3 priorità AI + CTA) | 2-3 giorni | TODO   |
| 2      | AI Triggers v2 inline                | 2 giorni   | TODO   |
| 3      | Confidence Score + Spiegazioni       | 1 giorno   | TODO   |
| 4      | Mobile Command Mode                  | 2-3 giorni | TODO   |
| 5      | Operational Scenarios                | 3-4 giorni | TODO   |
...
1. [ ] Rivedere spec con Gianfranco
2. [ ] Iniziare Sprint 1: Dashboard Hero
3. [ ] Test iterativi con Atlas
