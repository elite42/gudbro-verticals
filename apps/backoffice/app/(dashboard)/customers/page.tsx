            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-500 mt-1">
                  View and manage customers who follow your locale. See their visit history, order analytics, and loyalty status.
                </p>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg transition-shadow">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Read customer reviews, ratings, suggestions, and issue reports. Respond to feedback and mark items as resolved.
                </p>
        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-700 mt-0.5">
              You only see customers who explicitly follow your locale. GudBro users must opt-in to share their data with merchants.
