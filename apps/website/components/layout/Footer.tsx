...
const footerLinks = {
  ...
  solutions: [
    ...
    { name: 'Airbnb & Rentals', href: '/solutions/airbnb' },
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 lg:px-8 lg:py-16">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm leading-6">
              QR-powered digital experiences for hospitality businesses.
              Transform your restaurant, hotel, or rental property.
            </p>
        ...
        <div className="mt-12 border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-gray-400">
            &copy; {new Date().getFullYear()} GUDBRO. All rights reserved.
          </p>
          <p className="text-xs text-gray-400">
