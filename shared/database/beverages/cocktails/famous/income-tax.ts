...
export const incomeTax: Cocktail = {
  ...
  notes_for_staff:
    "Very similar to the Bronx but with added Angostura bitters. Always use fresh orange juice. The bitters are essential - don't skip them. Some versions use equal parts vermouths, others vary the ratio. Shake well to integrate all ingredients.",
