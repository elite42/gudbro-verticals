...
export const screwdriver: Cocktail = {
  ...
  notes_for_staff: 'Always use fresh-squeezed orange juice when possible - never bottled concentrate. Can adjust vodka-to-juice ratio to guest preference (standard is 1:2). Some guests prefer it built in the glass, others shaken. The Harvey Wallbanger is a popular variant (add Galliano float). Simple to batch for parties.',
  ...
  source: {
    ...
    note: 'IBA Official Recipe. Historical information from cocktail history sources and Smirnoff marketing archives.',
  },
