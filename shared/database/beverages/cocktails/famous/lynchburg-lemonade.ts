...
export const lynchburgLemonade: Cocktail = {
  ...
  ingredients: [
    {
      ...
      display_name: {
        ...
        it: "Jack Daniel's Tennessee Whiskey",
        vi: "Jack Daniel's Tennessee Whiskey",
      },
    },
    {
  ...
  notes_for_staff:
    "Traditionally made with Jack Daniel's specifically. Use fresh lemon juice, not bottled. Can increase whiskey portion for stronger version. Very popular in Southern U.S.",
  ...
  source: {
    ...
    notes: "Created 1980 by Tony Mason at TGI Friday's, Huntsville, Alabama.",
  },
