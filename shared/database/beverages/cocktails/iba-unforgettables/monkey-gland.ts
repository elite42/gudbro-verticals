...
export const monkeyGland: Cocktail = {
  ...
  notes_for_staff: 'Use fresh orange juice for best results. Absinthe should be used sparingly - just a hint to add complexity. Can substitute with pastis if absinthe unavailable. The name often requires explanation to curious guests - be prepared with the historical story.',
  ...
  source: {
    ...
    note: 'IBA Official Recipe. Historical information from Harry MacElhone\'s "Harry\'s ABC of Mixing Cocktails" and cocktail history sources.',
  },
