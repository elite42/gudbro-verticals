...
export const gymConfig = {
  ...
  location: {
    ...
    coordinates: { lat: 16.0600, lng: 108.2450 },
  },

  rating: { value: 4.7, count: 214 },

  openingHours: [
    { days: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'], open: '05:30', close: '22:00', label: 'Mon - Fri' },
...
export const passes: Pass[] = [
  {
    ...
    includes: ['Full gym access', 'Locker & towel', 'Hot/cold showers', 'WiFi', '1 group class (if scheduled)'],
  },
  {
    id: 'week',
    slug: 'week-pass',
    ...
    includes: ['Full gym access', 'Locker & towel', 'Hot/cold showers', 'WiFi', 'All group classes', 'Pool access'],
  },
  {
    id: '10entry',
    slug: '10-entry-pack',
    ...
    duration: 'No expiry',
    description: 'Buy 10 entries, use them anytime. Each visit deducts 1 entry. No expiration date.',
    includes: ['Full gym access', 'Locker & towel', 'Hot/cold showers', 'WiFi', 'All group classes', 'Pool access'],
    entries: 10,
  ...
  },
  {
    ...
    includes: ['Unlimited gym access', 'Locker & towel', 'Hot/cold showers', 'WiFi', 'All group classes', 'Pool & sauna', '1 free PT session'],
    popular: true,
  },
  {
    id: 'quarterly',
    ...
    includes: ['Unlimited gym access', 'Locker & towel', 'Hot/cold showers', 'WiFi', 'All group classes', 'Pool & sauna', '3 free PT sessions', 'Nutrition consultation'],
  },
  {
    id: 'yearly',
    ...
    includes: ['Unlimited gym access', 'Locker & towel', 'Hot/cold showers', 'WiFi', 'All group classes', 'Pool & sauna', '12 free PT sessions', 'Nutrition consultation', 'Free branded t-shirt', 'Guest pass x2'],
  },
];
...
export const instructors: Instructor[] = [
  {
    ...
    photo: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=200&h=200&fit=crop&crop=face',
...
export const courses: Course[] = [
  {
    ...
    description: 'Learn proper boxing technique: stance, jab, cross, hook, uppercut. Includes pad work, bag work, and conditioning drills. Suitable for complete beginners to intermediate.',
    level: 'All Levels',
    duration: 60,
    capacity: 16,
    currentEnrolled: 12,
    priceNote: 'Included with any pass',
    whatToBring: ['Hand wraps (available for purchase)', 'Water bottle', 'Towel', 'Comfortable sportswear'],
    schedule: [
  ...
  },
  {
    ...
    description: 'Flow through sun salutations, standing poses, balances, and deep stretches. Focus on breath-movement connection. Air-conditioned yoga studio with natural light.',
    level: 'All Levels',
    duration: 75,
    capacity: 20,
    currentEnrolled: 15,
  ...
  },
  {
    ...
    description: 'Workout of the Day combining weightlifting, gymnastics, and cardio. Scalable for all fitness levels. Whiteboard tracking and community atmosphere.',
    level: 'Intermediate',
    duration: 60,
    capacity: 14,
    currentEnrolled: 11,
  ...
  },
  {
    ...
    description: 'High-intensity interval training with bodyweight and light equipment. 45 minutes of maximum effort bursts followed by short recovery. Expect to burn 500-700 calories.',
    level: 'All Levels',
    duration: 45,
    capacity: 20,
    currentEnrolled: 18,
  ...
  },
  {
    ...
    instructor: 'Lisa Nguyen',
    instructorId: 'lisa-nguyen',
    description: 'Core-focused mat work combining strength, flexibility, and control. Great for posture correction and injury prevention. Uses resistance bands and small balls.',
    level: 'Beginner',
    duration: 50,
    capacity: 15,
    currentEnrolled: 10,
  ...
  },
  {
    ...
    description: 'Coached lap swimming sessions in our 20m pool. Technique drills, endurance sets, and stroke correction. Divided lanes by speed. Open water prep available.',
    level: 'Intermediate',
    duration: 60,
    capacity: 8,
    currentEnrolled: 5,
...
export const equipment: EquipmentCategory[] = [
  {
    name: 'Free Weights',
    icon: '🏋️',
    items: ['Dumbbells 2-50kg', 'Barbells (Olympic & Standard)', 'EZ-curl bars', 'Kettlebells 4-32kg', 'Weight plates (bumper & iron)', 'Adjustable benches x6'],
  },
  {
    name: 'Racks & Platforms',
    icon: '🔩',
    items: ['Power racks x4', 'Squat racks x2', 'Deadlift platforms x2', 'Smith machine', 'Cable crossover machine', 'Lat pulldown / Low row'],
  },
  {
    name: 'Machines',
    icon: '⚙️',
    items: ['Leg press', 'Hack squat', 'Leg curl / extension', 'Chest press', 'Shoulder press', 'Pec deck / Rear delt', 'Hip thrust machine', 'Glute kickback'],
  },
  {
    name: 'Cardio',
    icon: '🏃',
    items: ['Treadmills x8', 'Ellipticals x4', 'Stationary bikes x6', 'Rowing machines x3', 'Stairmaster x2', 'Assault bike x2'],
  },
  {
    name: 'Functional & Combat',
    icon: '🥊',
    items: ['Battle ropes', 'TRX suspension trainers', 'Plyo boxes', 'Medicine balls', 'Slam balls', 'Heavy bags x4', 'Speed bags x2', 'Boxing ring (small)'],
  },
  {
    name: 'Pool & Recovery',
    icon: '🏊',
    items: ['20m lap pool (4 lanes)', 'Sauna (dry)', 'Steam room', 'Cold plunge pool', 'Foam rollers & massage guns', 'Stretching area'],
  },
];
...
export const products: Product[] = [
  {
    ...
    category: 'Apparel',
    price: 250000,
    description: 'Premium cotton blend t-shirt with the Iron Paradise logo. Breathable, moisture-wicking fabric perfect for training or casual wear.',
  ...
  },
  {
    ...
    category: 'Gear',
    price: 450000,
    description: 'Quality synthetic leather boxing gloves with multi-layer foam padding. Suitable for bag work and pad drills. Velcro strap closure.',
  ...
  },
  {
    ...
    category: 'Gear',
    price: 80000,
    description: 'Semi-elastic hand wraps, 4.5m length. Essential for boxing and kickboxing. Protects knuckles and wrists during striking.',
  ...
  },
  {
    ...
    category: 'Gear',
    price: 350000,
    description: 'Non-slip TPE yoga mat, 6mm thickness. Lightweight, eco-friendly material with alignment lines. Includes carry strap.',
  ...
  },
  {
    ...
    price: 60000,
    description: 'Post-workout whey protein shake, 30g protein per serving. Available in chocolate, vanilla, and banana flavors. Made fresh at our protein bar.',
  ...
  },
  {
    ...
    category: 'Apparel',
    price: 200000,
    description: 'Lightweight training shorts with zip pocket. Quick-dry material with 4-way stretch. Iron Paradise embroidered logo.',
...
export const promotions: Promotion[] = [
  {
    ...
    badge: 'FREE',
    description: 'Try Iron Paradise for free! Your first visit is on us — full gym access, one group class, and all facilities included.',
  ...
  },
  {
    ...
    badge: '-15%',
    description: 'Get the 10-Entry Pack at 595,000₫ instead of 700,000₫. Limited time launch offer for our flexible pass.',
  ...
  },
  {
    ...
    badge: '-20%',
    description: 'Staying at a partner hotel? Get 20% off any pass. Show your room key or booking confirmation at reception.',
    details: 'Valid for guests of partner hotels in the Son Tra and My Khe area. Applies to day, weekly, and 10-entry passes.',
    validUntil: '2025-12-31',
    conditions: ['Valid hotel booking required', 'Partner hotels only', 'Day/Week/10-Entry passes', 'Cannot combine with convention pricing'],
...
export const insuranceOptions = [
  ...
  },
  {
    ...
    price: 120000,
    period: 'per month',
    covers: ['Accidental injury during gym use', 'Medical expenses up to 50M VND', 'Equipment damage coverage', 'Personal belongings in locker'],
  },
];
...
export const mockCustomer = {
  ...
  visitHistory: [
    ...
    { date: '2025-01-08', checkInTime: '06:55', checkOutTime: '08:30', class: 'Boxing Fundamentals' },
  ],
  documents: [
