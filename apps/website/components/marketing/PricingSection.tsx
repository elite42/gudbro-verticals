          ...
          {tiers.map((tier) => (
            <div
              ...
              className={`relative rounded-2xl p-8 ${
                tier.popular
                  ? 'bg-gray-900 text-white ring-4 ring-blue-500'
            ...
            >
              ...
              <div className="mt-4 flex items-baseline gap-1">
                {tier.price.monthly !== null ? (
                  <>
                    ...
                    <span className={tier.popular ? 'text-gray-300' : 'text-gray-500'}>
                      /month
                    </span>
                  </>
                ) : (
              ...
              {/* Description */}
              <p className={`mt-4 text-sm ${tier.popular ? 'text-gray-300' : 'text-gray-600'}`}>
                {tier.description}
              </p>
              ...
              <ul className="mt-8 space-y-3">
                {tier.features.map((feature) => (
                  <li key={feature} className="flex items-start gap-3">
                    <svg
                      className={`w-5 h-5 flex-shrink-0 ${tier.popular ? 'text-blue-400' : 'text-blue-600'}`}
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
