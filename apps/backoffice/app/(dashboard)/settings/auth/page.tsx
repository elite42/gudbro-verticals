...
const DEFAULT_PROVIDERS: OAuthProvider[] = [
  {
    ...
    description: 'Allow users to sign in with their Google account. Most popular option for web apps.',
  },
  {
    id: 'apple',
    name: 'Apple',
...
export default function AuthSettingsPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const providersConfig = providers.reduce((acc, p) => {
        acc[p.id] = {
          enabled: p.enabled,
    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">
          Configure social login options for your customers. {enabledCount} provider{enabledCount !== 1 ? 's' : ''} enabled.
        </p>
      </div>
        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-700 mt-0.5">
              1. Create an OAuth app on each provider&apos;s developer console<br />
              2. Copy the Client ID and Client Secret here<br />
              3. Add the callback URL to your OAuth app settings<br />
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5">
        <h3 className="font-semibold text-gray-900 mb-2">OAuth Callback URL</h3>
        <p className="text-sm text-gray-500 mb-3">
          Use this URL as the redirect/callback URL when setting up OAuth apps:
        </p>
        <div className="flex items-center gap-2">
          <code className="flex-1 px-4 py-2 bg-gray-100 rounded-lg text-sm font-mono text-gray-800 overflow-x-auto">
            {callbackUrl}
          </code>
          <button
            onClick={() => {
        ...
        {providers.map((provider) => (
          ...
          >
            ...
            <div className="p-5">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className={`w-12 h-12 rounded-xl bg-white border ${provider.color} flex items-center justify-center`}>
                    {provider.icon}
                  </div>
                  <div>
                    <div className="flex items-center gap-2">
            ...
            {editingProvider === provider.id && (
              <div className="px-5 pb-5 pt-3 border-t border-gray-200 bg-gray-50/50">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => updateProviderField(provider.id, 'client_id', e.target.value)}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => updateProviderField(provider.id, 'client_secret', e.target.value)}
                ...
                <div className="mt-4 flex items-center justify-between">
                  <div className="text-sm text-gray-500">
                    Scopes: <code className="bg-gray-200 px-1.5 py-0.5 rounded text-xs">{provider.scopes.join(', ')}</code>
                  </div>
                  <a
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-0.5">Traditional email/password authentication. Always available.</p>
            </div>
          </div>
        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-yellow-700 mt-0.5">
              After saving, the OAuth providers also need to be enabled in your Supabase Dashboard under Authentication → Providers.
              This is a security measure that requires admin access to Supabase.
            </p>
          </div>
        </div>
      </div>
