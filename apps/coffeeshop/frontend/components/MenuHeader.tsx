    ...
    <div className="relative">
      ...
      <div className="relative h-56">
        ...
        <div
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=1200&h=400&fit=crop&auto=format&q=75&fm=webp')`,
          }}
          role="img"
          aria-label="Restaurant menu hero image"
        >
          {/* Dark Overlay */}
          <div className="absolute inset-0 bg-black/40" />
        </div>

        {/* Top Bar - Language/Currency & Icons */}
