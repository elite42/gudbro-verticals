...
export const screamingOrgasm: Cocktail = {
  ...
  notes_for_staff:
    'Contains nut liqueur - check for allergies. Stronger than regular Orgasm due to vodka. Name may require discretion. Very popular at bachelor/bachelorette parties. Can be made as a cocktail over ice. Some recipes use equal parts of all five ingredients.',
  ...
  source: {
    ...
    notes: 'Stronger variation of the Orgasm shot, popular in 1980s-90s bar culture.',
  },
