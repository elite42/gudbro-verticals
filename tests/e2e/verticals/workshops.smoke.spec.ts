/**
 * Workshops PWA Smoke Tests
 *
 * Validates that the workshops vertical loads correctly, has proper navigation,
 ...
 *
 * Navigation: All 5 nav items are links (Home, Workshops, Explore/center, Deals, About).
 * Center item "Explore" is a Link to /search (not a button).
 *
 * Run: SKIP_WEBSERVER=1 npx playwright test --project=workshops-mobile
 */
...
const vertical = VERTICALS.workshops;
