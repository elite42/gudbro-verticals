...
const MOCK_LOCATIONS = [
  {
    ...
    slug: 'city-center',
    address: { street: '123 Tran Phu St', city: 'Da Nang', coordinates: { lat: 16.0544, lng: 108.2022 } },
    phone: '+84905234567',
  ...
  },
  {
    ...
    slug: 'my-khe-beach',
    address: { street: '456 Vo Nguyen Giap St', city: 'Da Nang', coordinates: { lat: 16.0385, lng: 108.2419 } },
    phone: '+84905234568',
    hours: [{ days: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'], open: '08:00', close: '22:00' }],
...
const MOCK_SERVICES = [
  {
    ...
    locations: ['loc-city', 'loc-beach'],
    staffIds: ['staff-linh'],
    pricing: { 'loc-city': { base: 450000, weekendPremium: 10 }, 'loc-beach': { base: 500000, weekendPremium: 15 } },
    isPopular: true,
    isFeatured: true,
  ...
  },
  {
    ...
    locations: ['loc-city', 'loc-beach'],
    staffIds: ['staff-linh'],
    pricing: { 'loc-city': { base: 400000, weekendPremium: 10 }, 'loc-beach': { base: 450000, weekendPremium: 15 } },
    isPopular: true,
    isFeatured: false,
  ...
  },
  {
    ...
    locations: ['loc-city'],
    staffIds: ['staff-mai'],
    pricing: { 'loc-city': { base: 650000, weekendPremium: 10, depositRequired: true, deposit: 100000 } },
    isPopular: true,
    isFeatured: true,
  ...
  },
  {
    ...
    locations: ['loc-city', 'loc-beach'],
    staffIds: ['staff-hoa'],
    pricing: { 'loc-city': { base: 300000, weekendPremium: 5 }, 'loc-beach': { base: 320000, weekendPremium: 5 } },
    isPopular: true,
    isFeatured: false,
  ...
  },
  {
    ...
    locations: ['loc-beach'],
    staffIds: ['staff-linh'],
    pricing: { 'loc-beach': { base: 1200000, weekendPremium: 20, depositRequired: true, deposit: 300000 } },
    isPopular: false,
    isFeatured: true,
...
router.get('/:hubId/staff/:staffId', param('hubId').isUUID(), (req, res) => {
  ...
  const staff = MOCK_STAFF.find(s => s.id === req.params.staffId || s.slug === req.params.staffId);
...
router.post('/:hubId/booking',
  ...
  (req, res) => {
    ...
    const location = locationId ? MOCK_LOCATIONS.find(l => l.id === locationId) : MOCK_LOCATIONS[0];
