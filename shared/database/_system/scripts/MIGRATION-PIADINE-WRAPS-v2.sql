-- ============================================================================
-- MASTER MIGRATION SCRIPT: PIADINE & WRAPS (v2 - Fixed taxonomy)
-- ============================================================================
-- ESEGUI QUESTO SCRIPT NEL SUPABASE SQL EDITOR
--
-- FIX: Usa category 'sandwich' invece di 'piadina' per product_taxonomy
-- ============================================================================
...
-- Piadine taxonomy (use 'sandwich' as category - it's the closest valid value)
INSERT INTO product_taxonomy (product_type, menu_type, service_type, category, display_name_en, display_name_it)
SELECT 'piadine', 'standalone', 'food', 'sandwich', 'Piadine', 'Piadine'
...
-- Wraps taxonomy (use 'sandwich' as category - wraps are similar)
INSERT INTO product_taxonomy (product_type, menu_type, service_type, category, display_name_en, display_name_it)
SELECT 'wraps', 'standalone', 'food', 'sandwich', 'Wraps', 'Wrap'
