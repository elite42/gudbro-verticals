...
export const CATEGORIES = [
  { slug: 'cooking', label: 'Cooking', emoji: '👨‍🍳', color: 'var(--cat-cooking)', viLabel: 'Nấu ăn' },
  { slug: 'craft', label: 'Crafts', emoji: '🏮', color: 'var(--cat-craft)', viLabel: 'Thủ công' },
  { slug: 'art', label: 'Art & Painting', emoji: '🎨', color: 'var(--cat-art)', viLabel: 'Nghệ thuật' },
  { slug: 'jewelry', label: 'Jewelry', emoji: '💎', color: 'var(--cat-jewelry)', viLabel: 'Trang sức' },
  { slug: 'bamboo', label: 'Bamboo Craft', emoji: '🎋', color: 'var(--cat-bamboo)', viLabel: 'Tre' },
  { slug: 'martial-arts', label: 'Martial Arts', emoji: '🥋', color: 'var(--cat-martial)', viLabel: 'Võ thuật' },
  ...
  { slug: 'ao-dai', label: 'Ao Dai / Fashion', emoji: '👗', color: 'var(--cat-fashion)', viLabel: 'Áo dài' },
  { slug: 'food-tour', label: 'Food Tours', emoji: '🍜', color: 'var(--cat-food-tour)', viLabel: 'Ẩm thực' },
];
