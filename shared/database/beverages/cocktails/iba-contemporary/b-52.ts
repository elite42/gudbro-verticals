...
export const b52: Cocktail = {
  ...
  ingredients: [
    ...
    },
    {
      ...
      quantity: { amount: 20, unit: 'ml' },
      display_name: { en: 'Irish cream (Baileys)', it: 'Crema irlandese (Baileys)', vi: 'Kem Ireland (Baileys)' },
    },
    {
      ingredient_id: 'ING_TRIPLE_SEC',
      quantity: { amount: 20, unit: 'ml' },
      display_name: { en: 'Triple sec (Grand Marnier)', it: 'Triple sec (Grand Marnier)', vi: 'Triple sec (Grand Marnier)' },
    },
  ],
  ...
  source: {
    ...
    note: 'IBA Official Recipe. Historical information from cocktail history sources and Peter Fich interviews.',
  },
