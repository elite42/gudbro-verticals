...
export const ginRickey: Cocktail = {
  ...
  notes_for_staff:
    "The hallmark of a Rickey is NO SUGAR - don't add simple syrup. Use fresh lime, never bottled. Originally made with bourbon (ask if customer wants original version). Drop spent lime half into drink - it's traditional.",
  ...
  source: {
    ...
    notes: "Created 1883 by George A. Williamson at Shoomaker's Bar, Washington D.C.",
  },
