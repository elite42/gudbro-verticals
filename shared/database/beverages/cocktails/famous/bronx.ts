...
export const bronx: Cocktail = {
  ...
  notes_for_staff: 'Must use fresh orange juice - never bottled or concentrate. The classic ratio is 3:1:1:1.5 (gin:sweet vermouth:dry vermouth:orange juice). Use quality vermouths and keep them fresh. Shake hard to properly integrate the orange juice.',
  ...
  source: {
    ...
    note: 'Classic recipe from Waldorf-Astoria (1906), documented in various early 20th century cocktail books.',
  },
