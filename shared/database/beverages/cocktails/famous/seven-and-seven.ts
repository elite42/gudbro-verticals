...
export const sevenAndSeven: Cocktail = {
  ...
  ingredients: [
    {
      ...
      display_name: {
        en: "Seagram's 7 Crown whiskey",
        it: "Whiskey Seagram's 7 Crown",
        vi: "Whiskey Seagram's 7 Crown",
      },
    },
    {
  ...
  notes_for_staff:
    'Traditionally made with Seagram\'s 7 Crown and 7-Up specifically, though Sprite can substitute. Can be made with other whiskeys but loses the authentic "7 and 7" name. Very popular in 1970s-80s America.',
  ...
  source: {
    ...
    notes: 'Marketing-driven cocktail from 1970s combining two "7" branded products.',
  },
