...
export const jagerBomb: Cocktail = {
  ...
  notes_for_staff: 'WARNING: High caffeine and alcohol content. Serve responsibly and be aware of mixing stimulants with depressants. Some regions have restrictions on serving these drinks. Ensure shot glass is sturdy to prevent breakage when dropped. Can substitute Red Bull with other energy drinks.',
  ...
  source: {
    ...
    note: 'Iconic 2000s bomb shot combining Jägermeister and energy drink.',
  },
