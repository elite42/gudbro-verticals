...
export interface ProductIngredient {
  ...
  quantity?: {
    amount: number;
    unit: 'g' | 'ml' | 'oz' | 'cups' | 'tbsp' | 'tsp' | 'teaspoon' | 'pieces' | 'dash' | 'dashes' | 'bar_spoon' | 'sprig' | 'cube' | 'drop' | 'drops' | 'splash' | 'whole' | 'leaves' | 'slice' | 'slices' | 'wedge' | 'wedges' | 'cl' | 'part' | 'parts' | string;
  };
