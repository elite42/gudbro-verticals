...
export const spritz: Cocktail = {
  ...
  notes_for_staff: 'Classic ratio is 3-2-1 (prosecco-Aperol-soda). Aperol = sweeter and more approachable. Campari = more bitter and traditional. Always serve in a large glass filled with ice. Don\'t overstir - keep it bubbly.',
  ...
  source: {
    ...
    note: 'IBA Official Recipe. Historical information from Venetian aperitivo culture and Aperol company archives.',
  },
