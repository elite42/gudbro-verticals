...
export const chiChi: Cocktail = {
  ...
  notes_for_staff:
    'Vodka version of Piña Colada. Use Coco López or similar cream of coconut (not coconut milk). Blend until smooth - consistency should be like a frozen dessert. Fresh pineapple juice highly recommended. Can also be served shaken over ice if blender unavailable.',
  ...
  source: {
    ...
    notes: 'Vodka variation of classic Piña Colada. Multiple origin claims.',
  },
