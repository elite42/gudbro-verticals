...
export const madras: Cocktail = {
  ...
  notes_for_staff: 'Use freshly squeezed orange juice for best results. Ratio of cranberry to orange can be adjusted to taste - some prefer equal parts. 100% cranberry juice recommended, not cocktail.',
  ...
  source: {
    ...
    note: 'Popular 1980s variation of the Cape Codder.',
  },
