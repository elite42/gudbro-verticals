...
const services = [
  ...
  },
  {
    ...
    turnaround: '24h',
    description:
      'Complete bedsheet set wash, dry and fold. Includes fitted sheet, flat sheet, pillowcases.',
...
export default function ServicesPage() {
  ...
  return (
    <div className="min-h-screen pb-24" style={{ backgroundColor: 'var(--cloud)' }}>
      {/* Header */}
      <div
        className="sticky top-0 z-30 px-4 pb-2 pt-3"
        style={{ backgroundColor: 'var(--cloud)', borderBottom: '1px solid rgba(74,144,217,0.08)' }}
      >
        <div className="mb-3 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Link href="/" className="rounded-lg p-1.5" style={{ color: 'var(--charcoal)' }}>
              <svg
                width="20"
                height="20"
                viewBox="0 0 24 24"
            ...
            <h1 className="font-display text-lg font-bold" style={{ color: 'var(--charcoal)' }}>
              All Services
            </h1>
          </div>
          <Link
        ...
        <div className="hide-scrollbar flex gap-2 overflow-x-auto pb-1">
          {categories.map((cat) => (
            <button
              ...
              style={{
                backgroundColor:
                  activeCategory === cat.id ? cat.color || 'var(--blue-hex)' : 'white',
                color: activeCategory === cat.id ? 'white' : 'var(--charcoal-muted)',
                boxShadow:
      ...
      <div className="flex items-center justify-between px-4 py-3">
        ...
        <select
          ...
          className="rounded-lg border-none bg-white px-2 py-1 text-xs font-medium"
      ...
      <div className="space-y-3 px-4">
        {filtered.map((service, idx) => (
          <Link
            ...
            className="shadow-soft hover-lift animate-fade-in-up flex overflow-hidden rounded-xl bg-white transition-all"
