...
export const harveyWallbanger: Cocktail = {
  ...
  ingredients: [
    ...
    },
    {
      ...
      display_name: { en: 'Galliano L\'Autentico', it: 'Galliano L\'Autentico', vi: 'Galliano L\'Autentico' },
    },
  ],
  ...
  notes_for_staff: 'The Galliano float is key - pour slowly over back of spoon to create visual layers. Use freshly squeezed orange juice. Garnish is important for presentation - this is a showpiece drink.',
  ...
  source: {
    ...
    note: 'Created by Duke Antone in 1952, popularized in 1970s by Galliano marketing.',
  },
