...
import { allIngredients as _allIngredients } from '../../index';
...
export const celeryJuice: Product = {
  ...
  ingredients: [{ ingredient_id: 'ING_CELERY', quantity: { amount: 300, unit: 'g' } }],
...
export const peanutButterToast: Product = {
  ...
  media: {
    images: {
      thumbnail:
        'https://images.unsplash.com/photo-1588137378633-dea1336ce1e2?w=400&h=300&fit=crop',
      gallery: [],
    },
  },
...
export const matchaOatsLatte: Product = {
  ...
  media: {
    images: {
      ...
      gallery: ['https://images.unsplash.com/photo-1515823064-d6e0c04616a7?w=800&h=600&fit=crop'],
    },
  },
...
export const espresso: Product = {
  ...
  ingredients: [{ ingredient_id: 'ING_ESPRESSO', quantity: { amount: 30, unit: 'ml' } }],
...
export const pancakes: Product = {
  ...
  description: {
    ...
    it: "Pila di pancakes soffici con sciroppo d'acero",
    vi: 'Bánh pancake xốp với siro phong',
  },
  category: { main: 'piatti-unici', sub: 'americano' },
  ingredients: [
  ...
  pricing: {
    ...
    selling_price_local: { amount: 110000, currency: 'VND' },
    profit_margin_percent: 66.7,
  },
...
export const pizzaMargherita: Product = {
  ...
  description: {
    en: 'Classic Italian pizza with tomato, mozzarella and basil',
    it: 'Pizza italiana classica con pomodoro, mozzarella e basilico',
    vi: 'Pizza Ý cổ điển với cà chua, phô mai mozzarella và húng quế',
  },
  ...
  pricing: {
    cost_usd: 2.5,
    selling_price_usd: 8.0,
    selling_price_local: { amount: 200000, currency: 'VND' },
...
export const padThai: Product = {
  ...
  description: {
    en: 'Classic Thai stir-fried rice noodles',
    it: 'Classici noodles di riso thai saltati',
    vi: 'Phở xào Thái cổ điển',
  },
  ...
  pricing: {
    cost_usd: 2.0,
    selling_price_usd: 6.5,
    selling_price_local: { amount: 160000, currency: 'VND' },
    profit_margin_percent: 69.2,
  },
  preparation: { prep_time_sec: 600, skill_level: 2, temperature: 'hot' },
  media: {
    images: {
      thumbnail: 'https://images.unsplash.com/photo-1559314809-0d155014e29e?w=400&h=300&fit=crop',
      gallery: [],
    },
  },
  availability: { time_slots: ['lunch', 'dinner'] },
...
export const classicBurger: Product = {
  ...
  description: {
    en: 'Juicy burger with lettuce, tomato, onion and special sauce',
    it: 'Hamburger succoso con lattuga, pomodoro, cipolla e salsa speciale',
    vi: 'Burger ngon ngọt với rau xà lách, cà chua, hành tây và sốt đặc biệt',
  },
  category: { main: 'piatti-unici', sub: 'americano' },
  ingredients: [
  ...
  pricing: {
    cost_usd: 3.0,
    selling_price_usd: 8.5,
    selling_price_local: { amount: 210000, currency: 'VND' },
    profit_margin_percent: 64.7,
  },
...
export const spritzCocktail: Product = {
  ...
  description: {
    en: 'Italian aperitif cocktail with Aperol, Prosecco and soda',
    it: 'Cocktail aperitivo italiano con Aperol, Prosecco e soda',
    vi: 'Cocktail khai vị Ý với Aperol, Prosecco và soda',
  },
  ...
  pricing: {
    cost_usd: 2.0,
    selling_price_usd: 7.0,
    selling_price_local: { amount: 175000, currency: 'VND' },
    profit_margin_percent: 71.4,
  },
  ...
  media: {
    images: {
      thumbnail:
        'https://images.unsplash.com/photo-1570797197190-8e003a00c846?w=400&h=300&fit=crop',
      gallery: [],
    },
  },
...
export const mojito: Product = {
  ...
  description: {
    en: 'Refreshing Cuban cocktail with rum, mint, lime and soda',
    it: 'Rinfrescante cocktail cubano con rum, menta, lime e soda',
    vi: 'Cocktail Cuba sảng khoái với rum, bạc hà, chanh và soda',
  },
...
export const tiramisu: Product = {
  ...
  description: {
    ...
    it: 'Classico dessert italiano con caffè, mascarpone e cacao',
    vi: 'Món tráng miệng Ý cổ điển với cà phê, mascarpone và ca cao',
  },
  ...
  pricing: {
    cost_usd: 2.5,
    selling_price_usd: 6.0,
    selling_price_local: { amount: 150000, currency: 'VND' },
...
export const cocaCola: Product = {
  ...
  description: {
    en: 'Classic refreshing cola drink',
    it: 'Classica bevanda rinfrescante alla cola',
    vi: 'Nước giải khát cola cổ điển',
  },
  ...
  media: {
    images: {
      thumbnail: 'https://images.unsplash.com/photo-1554866585-cd94860890b7?w=400&h=300&fit=crop',
      gallery: [],
    },
  },
...
export const beerHeineken: Product = {
  ...
  description: {
    en: 'Premium Dutch lager beer',
    it: 'Birra lager olandese premium',
    vi: 'Bia lager Hà Lan cao cấp',
  },
  ...
  pricing: {
    ...
    selling_price_local: { amount: 100000, currency: 'VND' },
    profit_margin_percent: 62.5,
  },
  preparation: { prep_time_sec: 30, skill_level: 1, temperature: 'cold' },
  media: {
...
export const frenchToast: Product = {
  ...
  description: {
    en: 'Classic French toast with maple syrup',
    it: "Toast alla francese classico con sciroppo d'acero",
    vi: 'Bánh mì Pháp kiểu cổ điển với xi-rô cây phong',
  },
  category: { main: 'piatti-unici', sub: 'americano' },
  ingredients: [],
  computed: {
...
export const croissant: Product = {
  ...
  description: {
    en: 'Flaky French butter croissant',
    it: 'Cornetto francese al burro sfogliato',
    vi: 'Bánh sừng bò Pháp bơ',
  },
  category: { main: 'piatti-unici', sub: 'italiano' },
  ingredients: [],
  computed: {
...
export const eggsBenedict: Product = {
  ...
  description: {
    ...
    vi: 'Trứng chần với sốt hollandaise',
  },
  category: { main: 'piatti-unici', sub: 'americano' },
  ingredients: [],
  computed: {
...
export const breakfastBurrito: Product = {
  ...
  description: {
    en: 'Eggs, bacon, cheese wrapped in tortilla',
    it: 'Uova, pancetta, formaggio in tortilla',
    vi: 'Trứng, thịt xông khói, phô mai cuốn trong bánh tortilla',
  },
...
export const phoBreakfast: Product = {
  ...
  description: {
    en: 'Traditional Vietnamese beef noodle soup',
    it: 'Zuppa vietnamita tradizionale di manzo e noodles',
    vi: 'Phở bò truyền thống Việt Nam',
  },
...
export const banhMi: Product = {
  ...
  description: {
    en: 'Vietnamese baguette with pork and pickled vegetables',
    it: 'Baguette vietnamita con maiale e verdure in salamoia',
    vi: 'Bánh mì thịt với rau cải chua',
  },
...
export const pizzaDiavola: Product = {
  ...
  description: {
    en: 'Spicy salami pizza',
    it: 'Pizza con salame piccante',
    vi: 'Pizza xúc xích cay',
  },
  category: { main: 'pizza', sub: 'italiano' },
  ingredients: [],
  computed: {
...
export const pizza4Formaggi: Product = {
  ...
  description: {
    ...
    it: 'Pizza con quattro formaggi',
    vi: 'Pizza bốn loại phô mai',
  },
  category: { main: 'pizza', sub: 'italiano' },
  ingredients: [],
  computed: {
...
export const pizzaProsciutto: Product = {
  ...
  name: {
    en: 'Pizza Prosciutto e Funghi',
    it: 'Pizza Prosciutto e Funghi',
    vi: 'Pizza Giăm Bông và Nấm',
  },
  description: {
    en: 'Ham and mushroom pizza',
    it: 'Pizza con prosciutto cotto e funghi',
    vi: 'Pizza giăm bông và nấm',
  },
  category: { main: 'pizza', sub: 'italiano' },
  ingredients: [],
...
export const carbonara: Product = {
  ...
  description: {
    en: 'Classic Roman pasta with eggs, cheese and guanciale',
    it: 'Pasta romana classica con uova, formaggio e guanciale',
    vi: 'Mì Ý kiểu La Mã với trứng, phô mai và thịt xông khói',
  },
...
export const amatriciana: Product = {
  ...
  description: {
    en: 'Tomato sauce with guanciale and pecorino',
    it: 'Salsa di pomodoro con guanciale e pecorino',
    vi: 'Sốt cà chua với thịt xông khói và phô mai',
  },
  category: { main: 'primi', sub: 'italiano' },
  ingredients: [],
  computed: {
...
export const aglioOlio: Product = {
  ...
  description: {
    en: 'Simple pasta with garlic, olive oil and chili',
    it: "Pasta semplice con aglio, olio d'oliva e peperoncino",
    vi: 'Mì Ý đơn giản với tỏi, dầu olive và ớt',
  },
  category: { main: 'primi', sub: 'italiano' },
  ingredients: [],
  computed: {
...
export const pestoPasta: Product = {
  ...
  description: {
    en: 'Pasta with fresh basil pesto sauce',
    it: 'Pasta con salsa al pesto fresco di basilico',
    vi: 'Mì Ý với sốt pesto húng quế tươi',
  },
  category: { main: 'primi', sub: 'italiano' },
  ingredients: [],
  computed: {
...
export const lasagna: Product = {
  ...
  description: {
    en: 'Layered pasta with meat sauce and béchamel',
    it: 'Pasta a strati con ragù e besciamella',
    vi: 'Mì Ý nhiều lớp với sốt thịt và sốt kem',
  },
  category: { main: 'primi', sub: 'italiano' },
  ingredients: [],
  computed: {
...
export const baconBurger: Product = {
  ...
  description: {
    en: 'Juicy burger with crispy bacon and cheese',
    it: 'Burger succoso con bacon croccante e formaggio',
    vi: 'Burger thịt bò với thịt xông khói giòn và phô mai',
  },
  category: { main: 'piatti-unici', sub: 'americano' },
  ingredients: [],
  computed: {
  ...
  media: {
    images: {
      thumbnail: 'https://images.unsplash.com/photo-1553979459-d2229ba7433b?w=400&h=300&fit=crop',
      gallery: [],
    },
  },
  availability: { time_slots: ['lunch', 'dinner', 'late-night'] },
...
export const veggieBurger: Product = {
  ...
  description: {
    en: 'Plant-based burger with fresh vegetables',
    it: 'Burger vegetale con verdure fresche',
    vi: 'Burger chay với rau tươi',
  },
  category: { main: 'piatti-unici', sub: 'americano' },
  ingredients: [],
  computed: {
...
export const chickenBurger: Product = {
  ...
  description: {
    en: 'Crispy fried chicken burger with lettuce and mayo',
    it: 'Burger di pollo fritto croccante con lattuga e maionese',
    vi: 'Burger gà chiên giòn với rau và sốt mayo',
  },
  category: { main: 'piatti-unici', sub: 'americano' },
  ingredients: [],
  computed: {
...
export const springRolls: Product = {
  ...
  description: {
    en: 'Vietnamese rice paper rolls with shrimp and vegetables',
    it: 'Involtini vietnamiti con gamberetti e verdure',
    vi: 'Gỏi cuốn tôm thịt',
  },
  ...
  media: {
    images: {
      thumbnail:
        'https://images.unsplash.com/photo-1594007759138-855ba53583f7?w=400&h=300&fit=crop',
      gallery: [],
    },
  },
...
export const friedRice: Product = {
  ...
  description: {
    en: 'Wok-fried rice with vegetables and egg',
    it: 'Riso saltato al wok con verdure e uova',
    vi: 'Cơm chiên rau củ và trứng',
  },
...
export const ramen: Product = {
  ...
  description: {
    en: 'Rich pork broth ramen with noodles and toppings',
    it: 'Ramen con brodo di maiale ricco, noodles e guarnizioni',
    vi: 'Ramen nước dùng heo đậm đà với mì và topping',
  },
...
export const sushiPlatter: Product = {
  ...
  description: {
    en: 'Assorted sushi and sashimi selection',
    it: 'Selezione assortita di sushi e sashimi',
    vi: 'Đĩa sushi và sashimi hỗn hợp',
  },
...
export const bunCha: Product = {
  ...
  description: {
    en: 'Grilled pork with vermicelli and herbs',
    it: 'Maiale grigliato con vermicelli e erbe aromatiche',
    vi: 'Bún chả thịt nướng Hà Nội',
  },
  category: { main: 'primi', sub: 'vietnamita' },
  ingredients: [],
  computed: {
...
export const tacos: Product = {
  ...
  description: {
    en: 'Soft tacos with seasoned beef, salsa and guacamole',
    it: 'Tacos morbidi con manzo speziato, salsa e guacamole',
    vi: 'Tacos thịt bò với salsa và bơ nghiền',
  },
  category: { main: 'piatti-unici', sub: 'messicano' },
  ingredients: [],
  computed: {
  ...
  media: {
    images: {
      thumbnail: 'https://images.unsplash.com/photo-1551504734-5ee1c4a1479b?w=400&h=300&fit=crop',
      gallery: [],
    },
  },
  availability: { time_slots: ['lunch', 'dinner', 'late-night'] },
...
export const quesadilla: Product = {
  ...
  description: {
    en: 'Grilled tortilla with cheese and chicken',
    it: 'Tortilla grigliata con formaggio e pollo',
    vi: 'Bánh tortilla nướng với phô mai và gà',
  },
  category: { main: 'piatti-unici', sub: 'messicano' },
  ingredients: [],
  computed: {
...
export const burrito: Product = {
  ...
  description: {
    en: 'Large flour tortilla filled with beef, rice and beans',
    it: 'Grande tortilla di farina ripiena di manzo, riso e fagioli',
    vi: 'Bánh tortilla lớn nhồi thịt bò, cơm và đậu',
  },
  category: { main: 'piatti-unici', sub: 'messicano' },
  ingredients: [],
  computed: {
...
export const negroni: Product = {
  ...
  description: {
    en: 'Classic Italian cocktail with gin, vermouth and Campari',
    it: 'Cocktail italiano classico con gin, vermouth e Campari',
    vi: 'Cocktail Ý cổ điển với rượu gin, vermouth và Campari',
  },
  ...
  media: {
    images: {
      thumbnail:
        'https://images.unsplash.com/photo-1609951651556-5334e2706168?w=400&h=300&fit=crop',
      gallery: [],
    },
  },
  availability: { time_slots: ['aperitivo', 'late-night'] },
...
export const cosmopolitan: Product = {
  ...
  description: {
    en: 'Vodka cocktail with cranberry and lime',
    it: 'Cocktail vodka con mirtillo rosso e lime',
    vi: 'Cocktail vodka với nước nam việt quất và chanh',
  },
...
export const margarita: Product = {
  ...
  description: {
    en: 'Classic tequila cocktail with lime and salt',
    it: 'Cocktail tequila classico con lime e sale',
    vi: 'Cocktail tequila cổ điển với chanh và muối',
  },
...
export const caipirinha: Product = {
  ...
  description: {
    en: 'Brazilian cachaça cocktail with lime and sugar',
    it: 'Cocktail brasiliano con cachaça, lime e zucchero',
    vi: 'Cocktail Brazil với rượu cachaça, chanh và đường',
  },
  ...
  media: {
    images: {
      thumbnail: 'https://images.unsplash.com/photo-1546171753-97d7676e9da6?w=400&h=300&fit=crop',
      gallery: [],
    },
  },
  availability: { time_slots: ['aperitivo', 'late-night'] },
...
export const ginTonic: Product = {
  ...
  description: {
    en: 'Classic gin and tonic with cucumber and lime',
    it: 'Gin tonic classico con cetriolo e lime',
    vi: 'Gin tonic cổ điển với dưa leo và chanh',
  },
  ...
  media: {
    images: {
      thumbnail:
        'https://images.unsplash.com/photo-1602280887959-d8c00a69e1e3?w=400&h=300&fit=crop',
      gallery: [],
    },
  },
  availability: { time_slots: ['aperitivo', 'late-night'] },
...
export const pannaCotta: Product = {
  ...
  description: {
    en: 'Italian cream dessert with berry sauce',
    it: 'Dessert italiano alla panna con salsa ai frutti di bosco',
    vi: 'Tráng miệng kem Ý với sốt quả mọng',
  },
  category: { main: 'dessert', sub: 'italiano' },
  ingredients: [],
  computed: {
...
export const gelato: Product = {
  ...
  description: {
    en: 'Artisan Italian ice cream - 3 scoops',
    it: 'Gelato artigianale italiano - 3 palline',
    vi: 'Kem Ý thủ công - 3 viên',
  },
  category: { main: 'dessert', sub: 'italiano' },
  ingredients: [],
  computed: {
...
export const cheesecake: Product = {
  ...
  description: {
    en: 'Classic baked cheesecake with graham cracker crust',
    it: 'Cheesecake classica al forno con base di biscotti',
    vi: 'Bánh phô mai nướng cổ điển với đế bánh quy',
  },
...
export const brownie: Product = {
  ...
  description: {
    en: 'Warm chocolate brownie with vanilla ice cream',
    it: 'Brownie al cioccolato caldo con gelato alla vaniglia',
    vi: 'Brownie socola nóng với kem vani',
  },
  category: { main: 'dessert', sub: 'americano' },
  ingredients: [],
  computed: {
...
export const redWine: Product = {
  ...
  description: {
    en: 'Glass of house red wine',
    it: 'Calice di vino rosso della casa',
    vi: 'Ly rượu vang đỏ nhà',
  },
...
export const whiteWine: Product = {
  ...
  description: {
    en: 'Glass of chilled house white wine',
    it: 'Calice di vino bianco fresco della casa',
    vi: 'Ly rượu vang trắng lạnh nhà',
  },
  ...
  media: {
    images: {
      thumbnail: 'https://images.unsplash.com/photo-1547595628-c61a29f496f0?w=400&h=300&fit=crop',
      gallery: [],
    },
  },
  availability: { time_slots: ['all-day'] },
...
export const prosecco: Product = {
  ...
  description: {
    en: 'Glass of Italian sparkling wine',
    it: 'Calice di vino spumante italiano',
    vi: 'Ly rượu vang sủi bọt Ý',
  },
  ...
  media: {
    images: {
      thumbnail:
        'https://images.unsplash.com/photo-1502301103665-0b95cc738daf?w=400&h=300&fit=crop',
      gallery: [],
    },
  },
  availability: { time_slots: ['all-day'] },
...
export const saigonBeer: Product = {
  ...
  description: {
    en: 'Vietnamese local lager beer',
    it: 'Birra lager vietnamita locale',
    vi: 'Bia lager Việt Nam',
  },
...
export const tigerBeer: Product = {
  ...
  description: {
    en: 'Singapore premium lager',
    it: 'Birra lager premium di Singapore',
    vi: 'Bia lager cao cấp Singapore',
  },
...
export const sparklingWater: Product = {
  ...
  description: {
    en: 'Bottle of sparkling mineral water',
    it: 'Bottiglia di acqua minerale frizzante',
    vi: 'Chai nước khoáng có ga',
  },
