...
export const spritzVeneziano: Cocktail = {
  ...
  ingredients: [
    ...
    },
    {
      ...
      display_name: { en: 'Soda water (splash)', it: 'Acqua gassata (splash)', vi: 'Nước soda (chút)' },
    },
  ],
  ...
  notes_for_staff: 'Classic ratio is 3-2-1 (Prosecco-Aperol-Soda). Use large wine glass filled with ice. Aperol is essential - Campari makes a different drink (Negroni Sbagliato). Garnish with orange slice, not twist.',
  ...
  source: {
    ...
    note: 'IBA Official Recipe. Originated in Venice, popularized globally in 2000s-2010s.',
  },
