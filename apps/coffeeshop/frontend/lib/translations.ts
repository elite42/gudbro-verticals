...
export const translations: Record<Language, Translations> = {
  ...
  en: {
    ...
    offers: {
      ...
      shareExperienceText:
        'Share your experience on social media and receive instant discount codes',
    ...
    account: {
      ...
      featuresMessage:
        'You will be able to save your favorite dishes, view order history, and much more!',
  ...
  vi: {
    ...
    offers: {
      ...
      shareExperienceText:
        'Chia sẻ trải nghiệm của bạn trên mạng xã hội và nhận mã giảm giá ngay lập tức',
    ...
    account: {
      ...
      featuresMessage:
        'Bạn sẽ có thể lưu các món ăn yêu thích, xem lịch sử đơn hàng và nhiều hơn nữa!',
  ...
  it: {
    ...
    offers: {
      ...
      shareExperienceText:
        'Condividi la tua esperienza sui social media e ricevi codici sconto istantanei',
    ...
    account: {
      ...
      featuresMessage:
        'Potrai salvare i tuoi piatti preferiti, visualizzare lo storico degli ordini e molto altro!',
