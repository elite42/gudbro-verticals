...
export const orgasm: Cocktail = {
  ...
  notes_for_staff:
    'Contains nut liqueur - check for allergies. Name may require discretion with certain clientele. Can be made as a cocktail over ice for slower consumption. Very popular party shot. Some recipes add vodka (becomes Screaming Orgasm).',
  ...
  source: {
    ...
    notes: 'Classic 1980s party shooter with provocative name.',
  },
