...
export const hurricane: Cocktail = {
  ...
  notes_for_staff:
    "Original Pat O'Brien's recipe is proprietary, but this is the classic formula. Can substitute passion fruit purée for syrup. Glass should be hurricane lamp-shaped. Very strong - warn guests it's deceptively potent.",
  ...
  source: {
    ...
    notes:
      "Based on classic New Orleans formula. Historical information from Pat O'Brien's Bar and New Orleans cocktail archives.",
  },
