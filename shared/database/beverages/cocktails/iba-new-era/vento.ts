...
export const vento: Cocktail = {
  ...
  notes_for_staff:
    'Use quality sweet vermouth (Carpano Antica, Cocchi). Good quality tonic water is important. Stir gently to preserve carbonation. Can use larger wine glass for more elegant presentation.',
  ...
  source: {
    ...
    notes: "IBA Official Recipe. Originated from Venice's aperitivo culture, 2017.",
  },
